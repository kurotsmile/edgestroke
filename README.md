...
Draw edge-based outlines around subjects for sticker and cutout style.

## Domain-friendly Name
- Project slug: `edgestroke`
- Suggested domain: `edgestroke.web.app` or `edgestroke.com`

## Features
- Edge Detect Stroke Around Subject
...
- macOS/Linux: `./run_web.command`
- Windows: `run_web.bat`
- Windows Incognito: `run_web_incognito.cmd`
- URL: `http://localhost:8115/index.html`
...
3. Initialize project if needed: `firebase use edgestroke-nh2672`
